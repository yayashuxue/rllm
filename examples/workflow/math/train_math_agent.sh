...
python3 -m examples.workflow.math.train_math_agent \
    ...
    algorithm.rejection_sample.multiplier=5.0 \
    algorithm.stepwise_advantage.enable=True \
    algorithm.stepwise_advantage.mode=broadcast \
    trainer.critic_warmup=0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='math-agent' \
    trainer.experiment_name='math-single-turn-workflow' \
