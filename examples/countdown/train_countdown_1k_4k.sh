...
MODEL_PATH=/data/sijun/rllm-zero/checkpoints/rllm-agent/countdown-qwen-0.6b-1k/global_step_225/actor/checkpoint
...
python3 -m examples.countdown.train_countdown \
    ...
    trainer.experiment_name='countdown-qwen-0.6b-1k-4k' \
