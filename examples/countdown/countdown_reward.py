...
# Alternative: use the existing math reward function for simplicity
def simple_countdown_reward_fn(task_info: dict, action: str) -> RewardOutput:
    """
    Simplified countdown reward function using existing math reward logic.
    """
