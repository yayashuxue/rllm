...
MODEL_PATH=/data/sijun/rllm-zero/checkpoints/rllm-agent/countdown-qwen-0.6b-2k-4k/global_step_50/actor/checkpoint
...
python3 -m examples.countdown.train_countdown \
    ...
    trainer.experiment_name='countdown-qwen-0.6b-2k-4k-8k' \
